...
{
    public class SequenceTrigger : ProcessBase
    {
        [Header("순서대로 누를 트리거 목록")]
        [SerializeField] private List<TriggerEnter> sequenceSteps;
        ...
        private void Update()
        {
            ...
            TriggerEnter expectedTrigger = sequenceSteps[_currentStepIndex];
